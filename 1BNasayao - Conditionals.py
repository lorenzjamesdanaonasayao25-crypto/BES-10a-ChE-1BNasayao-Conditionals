...
if inREAG == "NaOH":
    ...
    print("The amount of grams needed for", inMOL, inREAG, "is", xNaOH)

elif inREAG == "NH4OH":
    xNH4OH = float(inMOL)*float(molNH4OH)
    print("The amount of grams needed for", inMOL, inREAG, "is", xNH4OH)

elif inREAG == "KOH":
    xKOH = float(inMOL)*float(molKOH)
    print("The amount of grams needed for", inMOL, inREAG, "is", xKOH)

elif inREAG == "HCl":
    xHCl = float(inMOL)*float(molHCl)
    print("The amount of grams needed for", inMOL, inREAG, "is", xHCl)

elif inREAG == "H2SO4":
    xH2SO4 = float(inMOL)*float(molH2SO4)
    print("The amount of grams needed for", inMOL, inREAG, "is", xH2SO4)

elif inREAG == "H3PO4":
    xH3PO4 = float(inMOL)*float(molH3PO4)
    print("The amount of grams needed for", inMOL, inREAG, "is", xH3PO4)

elif inREAG == "KHP":
    xKHP = float(inMOL)*float(molKHP)
    print("The amount of grams needed for", inMOL, inREAG, "is", xKHP)

else:
    print("Invalid Reagent Name")